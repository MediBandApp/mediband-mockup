function App() {
  ...
  const [isLoggedIn, 
setIsLoggedIn] = React.useState(false);
  ...
  const [selectedBraceletColor, 
setSelectedBraceletColor] = React.useState('green');
        ...
        <div className="max-w-md mx-auto mt-12">
          ...
          onChange={handleChange}
            ...
            <button 
              ...
              className="w-full bg-green-500 text-white py-4 rounded-xl font-semibold 
    ...
    <div className="min-h-screen bg-red-50 p-6">
      ...
      <div className="max-w-md mx-auto mt-12 text-center">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          ...
          <button className="w-full bg-blue-500 text-white py-3 
rounded-xl font-semibold hover:bg-blue-600 transition mt-6">
      ...
      <div className="space-y-4">
        {medicalTests.map(test => (
          <div key={test.id} onClick={() => setSelectedTest(test)} className="bg-white rounded-2xl p-5 shadow-md cursor-pointer hover:bg-gray-50 transition">
            <p 
className="font-semibold text-gray-800">{test.name}</p>
  ...
  const HospitalVisitDetailPage = () => (
    <div className="p-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md space-y-3">
        ...
        <p>
<strong>Diagnosis Summary:</strong> {selectedVisit.diagnosis}</p>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <button
                  ...
                  className={`flex flex-col items-center p-6 rounded-xl shadow-md transition 
${addDataRole === 'patient' ? 'bg-blue-100 border-2 border-blue-500' : 'bg-white hover:bg-gray-50'}`}
                >
...
text-center">Step 2: Add Information</h3>
              {addDataRole === 'patient' && (
         ...
         <option value="medicalTest">Medical Test</option>
                  ...
                  <button type="submit" className="w-full bg-blue-500 text-white py-4 rounded-xl 
font-semibold hover:bg-blue-600 transition shadow-lg">
                    Submit Information
                  </button>
                </form>
              )}
              {addDataRole === 'doctor' && (
                <form onSubmit={(e) => { e.preventDefault(); handleSubmitDoctorData(); }} className="space-y-4">
                  ...
                  <input type="text" name="clinicName" placeholder="Hospital / Clinic Name" value={doctorFormData.clinicName} onChange={handleDoctorFormChange} 
className="w-full border-2 border-gray-300 rounded-xl p-3 focus:border-blue-500 outline-none" required />
      ...
      switch (medicalFileSubPage) {
        case 'overview':
          return (
            <div className="p-6">
              <h2 
className="text-2xl font-bold text-gray-800 mb-6">🧬 My Medical File</h2>
              <input 
                type="text" 
              ...
              <div className="space-y-4 mb-6">
                ...
                <div onClick={() => setMedicalFileSubPage('prescriptions')} className="bg-white rounded-2xl p-5 shadow-md flex items-center justify-between cursor-pointer hover:bg-gray-50 transition">
                  <span className="font-bold text-gray-800">Prescriptions 💊
</span>
                  <i className="fas fa-chevron-right text-gray-400"></i>
                </div>
    ...
    <div className="pb-24 min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="bg-gradient-to-r from-green-500 to-teal-500 text-white p-6 rounded-b-3xl flex items-center justify-between shadow-md">
        <div className="flex items-center">
          <img src="Gemini_Generated_Image_mn6rrkmn6rrkmn6r.png" 
alt="Mediband Logo" className="w-10 h-10 mr-3" />
          <div>
...
mx-auto mt-12">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-center bg-gray-50 p-4 
...
justify-center text-center">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg mb-8">
                ...
                <p className="text-sm text-gray-500 mt-2">This code will be printed on your bracelet.
</p>
              </div>
      ...
      <div className="p-6 space-y-4">
        <div className="bg-white rounded-2xl p-5 shadow-md">
          <div className="flex items-center mb-3">
            <div className="w-12 h-12 bg-blue-100 rounded-xl flex 
...
className="bg-white rounded-2xl p-5 shadow-md">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div>
              ...
              <p className="text-gray-600">Yes, compatible with Apple 
Health and Google Fit.</p>
            </div>
          </div>
        </div>
      </div>
